...
@section('content')
    <x-container>
        ...
        <div class="col-sm-6 col-xl-3">
            <x-widget title="Total Pegawai" :subTitle="$pegawai" class="bg-lime">
        ...
        <div class="col-sm-6 col-xl-3">
            <x-widget title="Total Kendaraan" :subTitle="$vehicles" class="bg-purple">
        ...
        <div class="col-sm-6 col-xl-3">
            <x-widget title="Total Inventaris" :subTitle="$inventaris" class="bg-lime">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-users" width="24"
                    height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                    stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
        ...
        <div class="col-sm-6 col-xl-3">
            <x-widget title="Total User" :subTitle="$customers" class="bg-lime">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-users" width="24"
                    height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                    stroke-linecap="round" stroke-linejoin="round">
                    <path stroke="none" d="M0 0h24v24H0z" fill="none"></path>
        ...
        {{-- <div class="col-sm-6 col-xl-3">
            <x-widget title="Total Pegawai" :subTitle="0" class="bg-green">
